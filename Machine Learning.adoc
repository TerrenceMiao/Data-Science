...
- **“把所有复杂问题都转化为基于随机数和各种分布的简单算术问题，这就是蒙特卡洛算法的精髓”**, _http://blog.sina.com.cn/s/blog_6c7e111d0102wckj.html_
- Occam's Razor / Ockham's Razor (奥卡姆剃刀) "Entities should not be multiplied unnecessarily", bias for the simplest hypothesis
